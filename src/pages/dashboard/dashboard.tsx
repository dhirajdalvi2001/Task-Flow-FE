  ...
  const charts = useMemo(() => [
    {
      ...
      icon: <CircleXIcon className="size-6 sm:size-10 text-white"/>,
    },
    {
      ...
      icon: <CircleCheckIcon className="size-6 sm:size-10 text-white"/>,
    },
    {
      ...
      icon: <CircleDashedIcon className="size-6 sm:size-10 text-white"/>,
    },
    {
      title: "Pending Tasks",
